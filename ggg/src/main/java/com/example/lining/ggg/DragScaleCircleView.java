...
public class DragScaleCircleView extends ImageView {
    ...
    protected void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        try {
            ...
            mGuideLineColor = typedArray.getInt(R.styleable.DragScaleCircleView_guideLineColor,Color.BLUE);
            ...
            mBorderColor = typedArray.getInt(R.styleable.DragScaleCircleView_borderColor, Color.BLUE);
        } finally {
            typedArray.recycle();
        }
    ...
    private void drawDarkenSurroundingArea(@NonNull Canvas canvas) {
        ...
        maskCanvas.drawColor(Color.BLUE);
